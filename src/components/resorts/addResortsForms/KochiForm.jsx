...
function KochiForm() {
    ...
    const handleSubmit = async (event) => {
        ...
        if(place.length ==0 ||  description.length==0 || testImage.length ==0){
            ...
            try {
                const response = await fetch("http://localhost:3001/packages/kochiresort", {
                    method: "POST",
                    body: formData,
                });
    ...
    return (
        ...
        <div className='w-full mx-auto h-auto  bg-cover'>
            <div className='  py-[100px]'>
                <h1 className=' text-[100px] uppercase text-white text-center'>add Kochi resort</h1>
